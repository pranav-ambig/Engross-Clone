...
export default function App(ModalVisible, 
                            setModalVisible, 
                            Duration, 
                            setDuration, 
                            Sessioncount, 
    ...
    function startHandler(){
        setDuration(tempDuration*60);
        setSessioncounter(Sessioncount);
            ...
            height={popupheight/2}>
                ...
                <View style={{
                    ...
                    <FlatList
                        data={time}
                        renderItem={({item})=>(
                            <TouchableHighlight underlayColor={"#eeeeee"} onPress={()=>tempDuration=item.name}>
                ...
                <View style={{
                    ...
                    <View style={{flex:9}}>
                        ...
                        data={session}
                        renderItem={({item})=>(
                            <TouchableHighlight underlayColor={"#eeeeee"} onPress={()=>{(setSessioncounter(item.name))}}>
                                <Text style={styles.unselected}>{item.name}</Text>
                            </TouchableHighlight>
                        )}
                        keyExtractor={(item) => item.id}
